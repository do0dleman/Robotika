...
Working with Max7219 driver using a bare Arduino can be quite complicated. However there is an already-written library that will take care of all the hard parts of communication with it, it is called [LedControl](https://github.com/wayoda/LedControl).
