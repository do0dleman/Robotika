...
Lai sazinātos ar HC-06, izmantojot smartfonu, mēs izmantosim Arduino Bluetooth Controller ([play market](https://play.google.com/store/apps/details?id=com.giumig.apps.bluetoothserialmonitor)).
