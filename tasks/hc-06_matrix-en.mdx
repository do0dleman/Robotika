...
description: Tasks about using HC-06 bluetooth module in pair with 8x8 LED matrix with Arduino.
---
# 8x8 LED matrix with HC-06

## Reference

In this tasks you will use HC-06 bluetooth module with Arduino to control 8x8 LED matrix. If you need to revise info about either of those, feel free to go to previous topics: [LED matrix](/en/tasks/matrix), [HC-06](/en/tasks/hc-06).
