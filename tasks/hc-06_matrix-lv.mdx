...
description: Uzdevumi par HC-06 Bluetooth moduļa izmantošanu kopā ar 8x8 LED matricu, izmantojot Arduino.
---
# 8x8 LED matrica ar HC-06

## Atsauce

Šajos uzdevumos tu izmantosi HC-06 Bluetooth moduli ar Arduino, lai kontrolētu 8x8 LED matricu. Ja tev nepieciešams pārskatīt informāciju par kādu no šiem elementiem, droši apmeklējiet iepriekšējās tēmas: [LED matric](/lv/tasks/matrix), [HC-06](/lv/tasks/hc-06).

## Uzdevums 1. TAttēla pārslēgšana
